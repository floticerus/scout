...
e=-1<e?e:this.length++;this[e]=d;this.cache.add(a,e);d.check();return this},once:function(a,b){var d=this;d.on(a,function(e,c){d.off(a);b(e,c)});return this},off:function(a){a=this.cache.get(a);-1<a&&(Array.prototype.splice.apply(this,[a,1]),this.cache.update());return this},get:function(a,b){var d=!1,e=this.cache.get(a);-1<e&&(d=this[e]);b&&b(d);return d},checkAll:function(){for(var a=0,b=this.length;a<b;++a)for(var d=this[a],e=g(d.selector),c=0,f=e.length;c<f;++c)m(e[c])||d.fn(e[c],c);return this},
check:function(a){this.get(a,function(a){a&&a.check()});return this}};c.scout=new k}})(window);
