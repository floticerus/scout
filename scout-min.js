...
{};for(var a=0,b=this.length;a<b;++a)this.cache[this[a].selector]=a;return this},on:function(a,b){var c=new f(a,b),g=this.cache[a]?this.cache[a]:this.length++;this[g]=c;this.cache[a]=g;c.check();return this},once:function(a,b){var c=this;c.on(a,function(g,d){c.off(a);b(g,d)});return this},off:function(a){this.cache.hasOwnProperty(a)&&this[this.cache[a]]&&(Array.prototype.splice.apply(this,[this.cache[a],1]),this.updateCache());return this},get:function(a,b){var c=!1;this.cache.hasOwnProperty(a)&&
